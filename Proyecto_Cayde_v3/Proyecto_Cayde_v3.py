...
def menu_instalaciones_espe():
    ...
    "23. Entrada(Santa clara)", "24. Laboratorios de fisica","26. Agregar posiciones","27. Otras posiciones","28. Salir"]
...
def imprimir_menu():
    ...
    while True:
        ...
        if opcion==24:
            ...
            #limpio pantalla
            os.system("cls")
            #agrego nuevos nodos a la lista
            agregar_nodos()
            os.system("pause")
            #limpio pantalla
            os.system("cls")
        ...
        if opcion==25:
            numero=len(otros)
            print("Posiciones agregadas recientemente:")
            for i in range(len(otros)):
                print(i+1,". ",otros[i])
            print("Ingrese una opcion: ",end="")
            if(numero==0):
                print("lista otros vacia")
            else:
                opcion_otros=validar_numeros_enteros()
                while(opcion_otros<1 or opcion_otros>len(otros)):
                    print("Intente de nuevo: ",end="")
                    opcion_otros=validar_numeros_enteros()
            os.system("cls")
            #rompo ciclo reptitivo
            break
...
def agregar_nodos():
    '''
    Funcion que crea nodos desde el programa
    Parametros:
        
    Retorna:
        Esta funcion no retorna ningun tipo de dato
    '''
    #ingreso el nombre del nuevo nodo que agregare a la lista
    nueva_nodo=input("Ingrese el nombre de la nueva ubicacion:")
    #agrego el nuevo nodo al grafo
    otros.append(nueva_nodo)
    #lista con el nombre de las ubicaciones predefinidas
    lista_ubicaciones=["1. Entrada( General Rumiñahui)", "2. Parqueadero Espe", "3. Edificio administrativo", "4. Biblioteca", "5. Patio central",
    "6. Canchas de basket","7. Canchas de voley","8. Residencia", "9. Parqueadero residencia", "10. Gimnasio_Coliseo", "11. Estadio de la ESPE",
    "12. Bloque A","13. Bar", "14. Admision y registro","15. Tecnologias de la informacion y comunicacion", "16. Bloque B", "17. Bloque C",
    "18. Bloque D", "19. Bloque H", "20. Bloque G", "21. Laboratorios de biotecnologia", "22. Edificio de centro de investigaciones",
    "23. Entrada(Santa clara)", "24. Laboratorios de fisica"]
    print("Elija al lado de que ubicacion se encuentra la nueva ubicacion: ")
    #imprimo las ubicaciones predefinidas
    for i in range(len(lista_ubicaciones)):
        print(lista_ubicaciones[i])
    print("Elija una opcion: ",end="")
    #ingreso numero entero para elegir una opcion del menu
    opcion_nueva_ubicacion=validar_numeros_enteros()
    #valido que ingrese numeros dentro del rango del menu
    while(opcion_nueva_ubicacion<1 or opcion_nueva_ubicacion>24):
        print("Elija una opcion valida dentro del menu: ",end="")
        opcion_nueva_ubicacion=validar_numeros_enteros()
    #uno el nodo dependiendo de que localizacion escogio el usuario
    if(opcion_nueva_ubicacion==1):
        grafo[0].append(24)
    if(opcion_nueva_ubicacion==2):
        grafo[1].append(24)
    if(opcion_nueva_ubicacion==3):
        grafo[2].append(24)
    if(opcion_nueva_ubicacion==4):
        grafo[3].append(24)
    if(opcion_nueva_ubicacion==5):
        grafo[4].append(24)
    if(opcion_nueva_ubicacion==6):
        grafo[5].append(24)
    if(opcion_nueva_ubicacion==7):
        grafo[6].append(24)
    if(opcion_nueva_ubicacion==8):
        grafo[7].append(24)
    if(opcion_nueva_ubicacion==9):
        grafo[8].append(24)
    if(opcion_nueva_ubicacion==10):
        grafo[9].append(24)
    if(opcion_nueva_ubicacion==11):
        grafo[10].append(24)
    if(opcion_nueva_ubicacion==12):
        grafo[11].append(24)
    if(opcion_nueva_ubicacion==13):
        grafo[12].append(24)
    if(opcion_nueva_ubicacion==14):
        grafo[13].append(24)
    if(opcion_nueva_ubicacion==15):
        grafo[14].append(24)
    if(opcion_nueva_ubicacion==16):
        grafo[15].append(24)
    if(opcion_nueva_ubicacion==17):
        grafo[16].append(24)
    if(opcion_nueva_ubicacion==18):
        grafo[17].append(24)
    if(opcion_nueva_ubicacion==19):
        grafo[18].append(24)
    if(opcion_nueva_ubicacion==20):
        grafo[19].append(24)
    if(opcion_nueva_ubicacion==21):
        grafo[20].append(24)
    if(opcion_nueva_ubicacion==22):
        grafo[21].append(24)
    if(opcion_nueva_ubicacion==23):
        grafo[22].append(24)
    if(opcion_nueva_ubicacion==24):
        grafo[23].append(24)
...
if __name__ == '__main__':
    #lista donde se agregara las nuevas posiciones de la ESPE
    otros=[]
    ...
    while True:
        ...
        print("El camino que debes tomar es:", voz_camino," ",otros)
